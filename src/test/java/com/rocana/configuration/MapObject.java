...
class MapObject {
  ...
  private Map<String, FlatObject> flatObjectMap;

  public Map<String, FlatObject> getFlatObjectMap() {
    return flatObjectMap;
  }

  @ConfigurationCollection(elementType = FlatObject.class)
  @ConfigurationProperty(name = "flat-objects")
  public void setFlatObjectMap(Map<String, FlatObject> flatObjectMap) {
    this.flatObjectMap = flatObjectMap;
  }

  @Override
  public String toString() {
    return Objects.toStringHelper(this)
      .add("flatObjectMap", flatObjectMap)
      .toString();
  }
